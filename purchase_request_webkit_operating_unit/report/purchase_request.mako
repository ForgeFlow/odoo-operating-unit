    ...
    %for request in objects :
        %if request.operating_unit_id:
            <table class="header" style="border-bottom: 0px solid black; width: 100%">
                        <tr>
                            <td>${helper.embed_logo_by_name(request.operating_unit_id.code)|n}</td>
                        ...
                        <tr>
                            <td>${request.operating_unit_id.partner_id.name |entity}</td>
                            <td/>
                        </tr>
                        <tr>
                            <td >${request.operating_unit_id.partner_id.street or ''|entity}</td>
                            <td/>
                        </tr>
                        <tr>
                            <td>${_('Phone:')} ${request.operating_unit_id.partner_id.phone or ''|entity} </td>
                            <td/>
                        </tr>
                        <tr>
                            <td>${_('Mail:')} ${request.operating_unit_id.partner_id.email or ''|entity}<br/></td>
                        </tr>
            </table> ${_debug or ''|n}
        %endif
