...
class account_balance(report_sxw.rml_parse, common_report_header):
    ...
    def lines(self, form, ids=None, done=None):
        ...
        if 'used_context' in form and 'operating_unit_ids' in \
                form['used_context']:
            ctx['operating_unit_ids'] = form['used_context'][
                'operating_unit_ids']
        parents = ids
...
del Service._services['report.account.account.balance']

report_sxw.report_sxw('report.account.account.balance', 'account.account',
                      'addons/account/report/account_balance.rml',
                      parser=account_balance, header="internal")
